'''
什么思路？
1）要牛场分开吗？- 图片大小敏感 - 按照图片大小来分
2）Normalize - 意义？| 将数据集中的数值集中一点
3）Loss换不换？
4）backbone换不换？
'''
...
use_labels = ['_background_', 'lf', 'rf', 'rb', 'lb', 'ey', 'mn', 'br']
...
for epoch in tqdm(range(EPOCHES)):
    ...
    if val_loss < best_loss:
        best_loss = val_loss
        torch.save(model.state_dict(), '/data/model_state/unet_area_1_0317.pth')
